...
const SUBMITTED_STATUSES = new Set<string>([
  ...
  CUENTA_COBRO_STATUS.PENDIENTE_SUPERVISOR,
  CUENTA_COBRO_STATUS.PENDIENTE_DIRECTOR,
  CUENTA_COBRO_STATUS.PENDIENTE_ENVIO_CAD,
  CUENTA_COBRO_STATUS.PENDIENTE_JEFE,
  CUENTA_COBRO_STATUS.ENVIADA_CONTRATISTA,
]);
